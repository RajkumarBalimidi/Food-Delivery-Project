<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="com.tap.foodapp.model.Restaurant, com.tap.foodapp.dao.RestaurantDAO, com.tap.foodapp.impl.RestaurantDAOImpl" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
<title>Verify Account Delete</title>
<style>
    body {
...
<body>
	...
	<%
		restaurantId = (Restaurant) session.getAttribute("restaurantId");
	%>
    ...
    <div>
        ...
        <form action="VerifyAccountDeleteRestaurant">
